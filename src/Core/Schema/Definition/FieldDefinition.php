...
final class FieldDefinition
{
    ...
    public function toArray(array $options = []): array
    {
        ...
        return array_filter([
            ...
            'help' => $this->help(),
            'col' => $this->col(),
            'editor' => $this->field->getMetadata('editor'),
            'toolbar' => $this->field->getMetadata('toolbar'),
            'upload' => $this->field->getMetadata('upload'),
            'resource' => $this->field->getMetadata('resource'),
            'detail' => $this->field->getMetadata('detail'),
